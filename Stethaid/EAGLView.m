...
- (id)initWithCoder:(NSCoder*)coder {
    ...
    if ((self = [super initWithCoder:coder])) {
        ...
        //Initialize a microphone? Or load a pre-recorded file
        
        
        //Take a sample from the beginning of the audio
        
        //Set it to the appropriate range to be plotted as a float with this GL plot
